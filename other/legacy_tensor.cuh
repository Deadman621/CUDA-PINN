...
namespace legacy {
    ...
    template<typename T>
    using init_tensor_2D = std::initializer_list<init_tensor_1D<T>>;

    template<typename T>
    using init_tensor_3D = std::initializer_list<init_tensor_2D<T>>;

    template<typename T>
    using init_tensor_4D = std::initializer_list<init_tensor_3D<T>>;
